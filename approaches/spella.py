...
def get_details(file_name):
    """
    Extract details from PDF using spella approach
    Args:
    ...
    dummy_data = {
        ...
        'Amount': [1000, 2000],
        'Vendor': ['spella Vendor 1', 'spella Vendor 2'],
        'Description': ['Item 1 from spella', 'Item 2 from spella']
    }

    df = pd.DataFrame(dummy_data)
    print(f"[SPELLA] Processed {file_name} - Found {len(df)} records")
    return df
